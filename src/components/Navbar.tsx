                ...
                <nav style={{ boxShadow: '0 0 30px 2.5px #0a0a0a' }} className="flex h-14 max-w-[46rem] w-screen bg-gradient-to-br from-primary/90 to-secondary/90 backdrop-blur-md rounded-lg border-1 border-accent px-4">
                    <div className="flex flex-row items-center justify-between w-full">
                        <div className="flex flex-row gap-2 items-center">
                            <img draggable={false} className="h-10 w-10" src="https://r2.e-z.host/2baf151e-582b-4dd3-9816-3a257a697cfe/74t5u2oj.png" />
                        ...
                        <div className="min-[330px]:flex hidden flex-row gap-2 items-center">
                            <a draggable={false} href="https://thighs.wtf/snowyjs" target="_blank" className="p-2 duration-300 text-text text-lg font-medium hover:bg-secondary font-leaguespartan rounded-md">
                                Other Bio
                            </a>
                        </div>
                    </div>
